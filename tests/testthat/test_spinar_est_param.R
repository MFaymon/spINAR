...
test_that("input", {
  ...
  ######################## distr ########################
  # distr is either poi, geo or nb
  # P: "Must be element of set {'poi','geo','nb'}, but is 'POI'."
...
test_that("output size", {
  ...
  # Q: feasible region
  #expect_equal(spinar_est_param(x = c(2, 2, 2, 2, 2), p = 2, type="ml",distr = "poi"))
  #expect_equal(spinar_est_param(x = c(2, 2, 2, 2, 2), p = 1, type="mom",distr = "poi"))
  ...
  #expect_true(spinar_est_param(x = c(2, 3, 1, 1, 0), p = 2, type="ml", distr = "nb")[2]>0)
  # Q. why this is not in the feasible region
  # expect_true(spinar_est_param(x = c(2, 3, 1, 1, 0), p = 2, type="mom", distr = "geo")[2]<1)
  ...
  # Q: why this give us an error
  # expect_true(spinar_est_param(x = c(2, 3, 1, 1, 0), p = 2, type="ml", distr = "nb")[2]<1)
  ######################## type ########################
